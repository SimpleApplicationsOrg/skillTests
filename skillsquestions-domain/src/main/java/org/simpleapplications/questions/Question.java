...
public class Question {
  ...
  @Fetch
  @RelatedTo(type = "FOR_SKILL", direction = Direction.OUTGOING)
  private Skill skill;
  ...
  private void validateAnswers(List<Answer> answers) {
    if (answers == null) {
      throw new NullPointerException("Answers can not be null");
    }
    if (CollectionUtils.isEmpty(answers)) {
      throw new IllegalArgumentException("Answers can not be empty");
    }
  }
